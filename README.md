...
RootMC area mapper â€” polygon waypoints, boundary refine, lava pairs

| Field | Value |
|-------|-------|
| **Folder / artifact** | `root-mapper` |
| **Version** | `1.7.0` |
| **Bukkit name** | `Root-Mapper` |
| **Paper API** | `26.1` |
| **Author** | Root Record |
| **Website** | https://rootmc.net |
| **Main class** | `com.rootrecord.minecraft.rootmapper.RootMapperPlugin` |

## Install

1. Install **[Root-Core](https://github.com/RootRecord/root-core)** first (license/cloud spine for the suite).
2. Download `root-mapper-1.7.0.jar` from [Releases](https://github.com/RootRecord/root-mapper/releases) or the [plugin catalog](https://rootmc.net/plugins/).
3. Remove any older `root-mapper-*.jar` from `plugins/`.
...
.\build-with-server-jdk.bat :plugins:root-mapper:jar
```
...
| Command | Description |
|---------|-------------|
| `/mapper` | Map polygon areas for RootMC features |
...
| This plugin page | https://rootmc.net/plugins/root-mapper/ |
...
| GitHub (this repo) | https://github.com/RootRecord/root-mapper |
| Releases | https://github.com/RootRecord/root-mapper/releases |
